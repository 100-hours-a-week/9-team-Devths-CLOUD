# ============================================================================
# IAM (EC2 및 CodeDeploy 역할)
# ============================================================================

# KMS 키 조회 (SSM Parameter 암호화용 - 수동 관리)
data "aws_kms_alias" "ssm_params" {
  name = "alias/ssm-params-dev"
}
...
module "iam" {
  ...
  tempo_bucket_arn         = data.terraform_remote_state.vpc.outputs.tempo_bucket_arn
