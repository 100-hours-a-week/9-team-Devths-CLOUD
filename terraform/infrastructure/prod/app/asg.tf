...
module "asg_fe" {
  ...
  security_group_ids        = [data.terraform_remote_state.network.outputs.fe_security_group_id]
  ...
  target_group_arns         = [data.terraform_remote_state.network.outputs.target_group_fe_arn]
...
module "asg_be" {
  ...
  key_name                  = var.key_name
  security_group_ids        = [data.terraform_remote_state.network.outputs.be_security_group_id]
  iam_instance_profile_name = module.iam.ec2_instance_profile_name
  ...
  health_check_type         = var.asg_health_check_type
  health_check_grace_period = var.asg_health_check_grace_period
  target_group_arns         = [data.terraform_remote_state.network.outputs.target_group_be_arn]
...
module "asg_ai" {
  ...
  key_name                  = var.key_name
  security_group_ids        = [data.terraform_remote_state.network.outputs.ai_security_group_id]
  iam_instance_profile_name = module.iam.ec2_instance_profile_name
  ...
  health_check_type         = var.asg_health_check_type
  health_check_grace_period = var.asg_health_check_grace_period
  target_group_arns         = [data.terraform_remote_state.network.outputs.target_group_ai_arn]
