...
data "aws_iam_role" "ec2_role" {
  name = "devths-v1-dev-ec2-role"
}

data "aws_iam_instance_profile" "ec2_profile" {
  name = "devths-v1-dev-ec2-instance-profile"
}
...
module "monitoring" {
  ...
  # 모니터링 대상 IP 주소
  target_dev_ip     = data.terraform_remote_state.dev.outputs.instance_private_ip
  target_staging_ip = data.terraform_remote_state.staging.outputs.instance_private_ip
